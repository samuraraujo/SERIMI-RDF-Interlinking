...
=== 1. Data repository 
Serimi ONLY works over Virtuoso Sparql Endpoints. Therefore, you need to provide the Virtuoso target endpoint load or load your data on a Virtuoso Openlink server ({download here}[http://sourceforge.net/projects/virtuoso/files/]) if you want to use this tool.
...
If everything is fine, this command will print help information about Serimi. Below you find information how to use it.
...
You can change the value of thresholds used in Serimi. The are two parameter for that:
...
-y: allow you to define a threshold for the RDS function implemented in Serimi. Currently the value for this parameter is computed automatically. You can enforce a specific value for this parameter. You can define a value between (0,1).